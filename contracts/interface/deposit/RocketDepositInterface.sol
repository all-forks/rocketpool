...
contract RocketDepositInterface {
    function create(address _userID, address _groupID, string memory _durationID) payable public returns (bytes32);
    ...
    function setDepositBackupWithdrawalAddress(address _userID, address _groupID, bytes32 _depositID, address _backupWithdrawalAddress) public returns (bool);
}
